    ...
    <AdminLayout>
        <template #header>
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Create, edit, and delete tags.</p>
            </div>
        </template>

        <div class="space-y-6">
            <!-- Create -->
            <form @submit.prevent="createTag" class="rounded-lg border bg-white p-4 space-y-4">
                <div class="text-sm font-semibold text-gray-900">New Tag</div>
            ...
            <div class="rounded-lg border bg-white">
                <div class="border-b p-4">
                    <div class="text-sm font-semibold text-gray-900">All Tags</div>
                </div>
                        ...
                        <tbody class="divide-y bg-white">
                            ...
                            <tr v-for="tag in tags" :key="tag.id" class="hover:bg-gray-50">
                                ...
                                <template v-else>
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="text-sm text-gray-700">{{ tag.slug }}</div>
                                    </td>

                                    <td class="px-4 py-3 text-right">
                                        <div class="flex justify-end gap-2">
                                            <SecondaryButton type="button" @click="startEdit(tag)">
                                                Edit
                                            </SecondaryButton>
                                            <DangerButton type="button" @click="deleteTag(tag)">
                                                Delete
                                            </DangerButton>
                                        </div>
                                    </td>
